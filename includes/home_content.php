    ...
    //   while($row = pg_fetch_row($result))
      foreach ($postsSubArr as $row) 
      {
        if($row[5] > 0 && $row[5] < 10 )
        {
          ...
          echo "<h5 class=\"postDate\">$row[4]</h5>\n";
          if ($row[6] !="") {
            echo "<div class=\"center\">";
            echo "<img class=\"cardimg\" src=\"$row[6]\" alt=\"$row[7]\">\n";
            echo "</div>";
          }
          ...
          echo "<a class=\"readMoreButton\" href=\"/demos/blog/$row[2]\" data-link>Read More <span class=\"sherbert\">>></span></a>\n";
          echo "</div>\n";
          echo "</div>\n";
        }
      }
